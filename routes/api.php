...
// JADWAL PELAJARAN
// --------------------
Route::middleware(['auth:sanctum', 'role:guru,it'])->group(function () {
...
// EXPORT DATA
// --------------------
Route::middleware(['auth:sanctum', 'role:it,guru,bk'])->group(function () {
    // Export data absensi
...
// --------------------
Route::middleware(['auth:sanctum', 'role:siswa,guru,bk,it'])->group(function () {
