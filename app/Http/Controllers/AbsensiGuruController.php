...
class AbsensiGuruController extends Controller
{
    ...
    public function absenMasuk(Request $request)
    {
        ...
        if (!$zona) return response()->json(['message' => 'Zona absensi belum diatur'], 400);
        ...
        if ($absensiHariIni && $absensiHariIni->jam_masuk) {
            return response()->json(['message' => 'Anda sudah melakukan absensi masuk hari ini'], 400);
        }
        ...
        return response()->json(['message' => 'Absensi masuk berhasil', 'data' => $absensi], 201);
    }
    ...
    public function absenPulang(Request $request)
    {
        ...
        return response()->json(['message' => 'Absensi pulang berhasil', 'data' => $absensiHariIni]);
    }
